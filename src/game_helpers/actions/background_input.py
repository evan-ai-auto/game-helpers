...
This adapter uses ordinary window messages (PostMessageW). It does not move the
real cursor and does not activate the target window. Whether a particular game
accepts these messages is application-specific; many games use Raw Input or
other input paths instead.
"""
...
class BackgroundInput:
    """Post mouse messages directly to a target Win32 window."""
