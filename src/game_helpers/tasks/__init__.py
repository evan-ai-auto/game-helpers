...
__all__ = [
    ...
    "TaskRouteDecision", "TaskStep", "TravelEdge", "VerificationSession", "VisualAnchor", "VisualPositionType",
    "VisualStateObservation", "VisualStateProfile", "VisualStateStatus", "claim_verification_result", "detect_soul_task_claimed_icon",
