...
| 道具栏相关 | `item_panel_flow.py:run_item_panel_detect_and_toggle` | `dao_ju_lan` |
| 摄妖香相关 | `incense_capability_flow.py:run_demon_repellent_incense` | `demon_repellent_incense` |
| 寻找指定 NPC 角色并交互 | （占位） | `find_npc_and_interact` |
